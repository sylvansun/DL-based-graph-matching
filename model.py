...
class GMNet(torch.nn.Module):
    ...
    def forward(self, img1, img2, kpts1, kpts2, A1, A2):
        ...
        feat1_local_upsample = torch.nn.functional.interpolate(feat1_local, self.obj_resize, mode='bilinear')
        feat1_global_upsample = torch.nn.functional.interpolate(feat1_global, self.obj_resize, mode='bilinear')
        feat2_local_upsample = torch.nn.functional.interpolate(feat2_local, self.obj_resize, mode='bilinear')
        feat2_global_upsample = torch.nn.functional.interpolate(feat2_global, self.obj_resize, mode='bilinear')
